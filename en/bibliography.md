...
|---|---|---|
| 2 | Bob McGrew × Y Combinator (2025) | YC interview — origin of "Sell the outcome, not the product" |
| 3 | AWS Generative AI Innovation Center site | Public 45-day / 73% / 22-partner figures |
| 4 | Palantir AI FDE official documentation | https://palantir.com/docs/foundry/ai-fde/overview |
...
## 3. Industry Blogs & Playbooks

| Source | Title |
|---|---|
| Jediteck | *What is a Forward Deployed Engineer?* |
| Kiadev | *What Is a Forward Deployed Engineer (FDE)?* |
| Oflight (Japan) | *FDE: From Palantir's Original Playbook to 2026 Guide* |
...
In running text, citations use these short forms:

- Short citation: `[Lawrence 2025]` / `[McGrew @ YC 2025]` / `[AWS GenAI site]`
